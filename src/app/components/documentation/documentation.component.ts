  ...
  readonly sections: readonly DocSection[] = [
    ...
    },
    {
      ...
      items: [
        ...
        'Actualisez un dossier avec le bouton de rafraichissement dans l en-tete de la liste. Le dossier se rafraichit aussi automatiquement quand l onglet reprend le focus.',
        ...
        'Sur mobile, glissez un message vers la gauche ou la droite pour declencher l action choisie dans Reglages. La ligne se colore selon l action puis se replie pour confirmer le geste.',
        'Cliquez sur une notification de bureau pour ouvrir directement le message correspondant, meme si l application est fermee.',
    ...
    },
    {
      ...
      items: [
        ...
        'Pour les comptes Microsoft personnels (live, hotmail, outlook), utilisez le bouton Se connecter avec Microsoft : l authentification par mot de passe a ete desactivee par Microsoft, OAuth est requis.',
        'La connexion OAuth ouvre une fenetre du fournisseur (Microsoft ou Google) ; aucune information sensible ne transite par Kyma.',
        'Signatures : creez une ou plusieurs signatures et choisissez celle utilisee par defaut.',
        'General : reglez le theme, la taille des pages, la couleur d accent et les gestes mobiles (action a gauche / a droite).',
