...
def test_flow():
    with sync_playwright() as p:
        ...
        page.evaluate("window.addEventListener('storage', (e) => console.log('Storage event:', e.key, e.oldValue, e.newValue))")

        # Override setItem/removeItem
        page.evaluate("""
